...
*/
var operationSignal = "a";
var azao = calculator(operationSignal);

if(!!azao){
    number1 = 10;
    number2 = 2;
    console.log(showOperationMessage(operationSignal, number1, number2), azao(number1, number2));
} else {
    console.log(showErrorMessage(operationSignal));
}
